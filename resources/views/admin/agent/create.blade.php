...
@section('content')
{{ Breadcrumbs::render('agent.create') }}
...
<div class="col-lg-6">
    <div class="portlet box border shadow">
        ...
        <div class="portlet-body">
            @include('main.error')
            <form role="form" action="{{route('agent.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="mobile" value="{{old('mobile')}}" class="form-control" placeholder="همراه">
                        </div><!-- /.input-group -->
                    </div><!-- /.form-group -->
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="password" value="{{old('password')}}" class="form-control" placeholder="رمز">
                        </div><!-- /.input-group -->
                    </div><!-- /.form-group -->
                    <div class="form-group">
                        <label> ایمیل</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="level"  class="form-control">
                                <option {{old('level')=='manager'?'selected':''}} value="manager">  مدیر</option>
                                <option {{old('level')=='analyzer'?'selected':''}} value="analyzer">  تحلیل گر</option>
                            </select>
                        </div><!-- /.input-group -->
                    </div><!-- /.form-group -->
