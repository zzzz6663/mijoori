                ...
                <div>
                                            ...
                                            <a href="{{ route('logout') }}">
                                                <span class="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="icon icon-tabler icon-tabler-logout" width="16"
                                                        height="16" viewBox="0 0 24 24" stroke-width="1.5"
                                                        stroke="#008000" fill="none" stroke-linecap="round"
                    ...
                    <div class="mainmenu">
                        <ul>
                            ...
                            <li><a href="#" id="travel_pop_but">سفر سفارشی</a></li>
                                ...
                                <div class="col-lg-6 col-xsm-12">
                                    <div>
                                        ...
                                        <input class="popinput persian v2" id="b_date" type="text"
                                            name="b_date" value="" placeholder="تاریخ تولد">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xsm-12">
                                    <div>
